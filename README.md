...
- 🔬 Currently working on computer vision (specifically scene recognition) and LLM
- 🟢 Currently a green hand in contributions...
- 🏓 Table tennis enthusiast (Highest all-time score on ChinaTT: **1681**)

## 📄 Representative Work

### Topology-Aware Vision Transformers for Enhanced Scene Recognition (AAAI 2026, **Oral**)
